...
model = YOLO(r'D:\daniel project\wheel 2\wheel_axle_detection_model.pt')

# Path to the video file
video_path = r'D:\daniel project\wheel 2\videos\vi1.mp4'  # Change this to your video file path
