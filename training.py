...
if __name__ == "__main__":
    ...
    model_name = r'D:\daniel project\wheel 2\yolov8n.pt'  # Path to YOLOv8n model
    ...
    results = model.train(
        data=r'D:\daniel project\wheel 2\data.yaml',  # Path to the YAML file
        epochs=200,               # Increased number of epochs for better training
        imgsz=640,                # Image size
        batch=8,                 # Increased batch size if GPU allows
        name='wheel_detection',    # Save name for the run
    ...
    model.save('wheel_axle_detection_model.pt')
    ...
    print("tensorboard --logdir training_results/wheel_detection")
